...
protected:
    ...
    void notifyWords()
    {
        ...
        {
            ((WordModel*)m_words->objectAtIndex(i))->cellChanged(this);
        }
    }
...
public:
    ...
    CCArray* getWords() { return m_words;}
    ...
    WordModelState getWordState()
    {
        ...
        for (int i=0;i<m_words->count();i++)
        {
            WordModelState state = ((WordModel*)m_words->objectAtIndex(i))->getState();
...
protected:
    ...
    void refreshScore()
    {
        ...
        for (int i = 0;i<m_words->count();i++)
        {
            WordModel* word = (WordModel*)m_words->objectAtIndex(i);
...
public:
    ...
    {
        return (CellModel*)m_cells->objectForKey(CellModel::keyForCoords(x,y));
    }
