...
protected:
    ...
    void drawLetterInCell(int letterId_)
    {
        ...
        m_letter = CCSprite::create("letter_background.png");
        m_letter->retain();
        
        
        CCLabelTTF* label =  CCLabelTTF::create(letter["label"].asString().c_str(),WC_DEFAULT_FONT_BOLD,40);
        ...
        CCLabelTTF* points =  CCLabelTTF::create(stringForNum(letter["points"].asInt()).c_str(),WC_DEFAULT_FONT,20);
...
public:
    ...
    void refreshFromModel()
    {
        ...
        {
            m_open = true;
            m_background = CCSprite::create("open_tile.png");
    ...
    void displayBoardState(WordModelState state_)
    {
        ...
        {
            m_stateSprite = CCSprite::create("word_made_tile.png");
    ...
    void setSelected()
    {
        ...
        m_selectedBackground = CCSprite::create("selected_tile.png");
