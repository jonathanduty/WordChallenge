...
SceneController::SceneController()
{
    ...
    CCNotificationCenter::sharedNotifCenter()->addObserver(this, callfuncO_selector(SceneController::notificationLoginCompleteCallback), WC_EVENT_LOGIN_COMPLETE, NULL);
}

SceneController::~SceneController()
{
    CCNotificationCenter::sharedNotifCenter()->removeObserver(this, WC_EVENT_LOGIN_COMPLETE);
}
